...
import { signOut } from 'next-auth/react'; // Assuming you will move CSS to a module
          ...
          <ul className="nav nav-pills flex-column mt-3">
            <li className="nav-item my-1">
              <Link
                ...
                className={`nav-link text-dark fs-5 d-flex align-items-center ${
                  currentPath === "/employee/arptc" ? classes.active : ""
                }`}
              >
            ...
            <li className="nav-item my-1">
              <Link
                href="/employee/users"
                className={`nav-link text-dark fs-5 d-flex align-items-center ${
                  currentPath === "/employee/users" ? classes.active : ""
                }`}
              >

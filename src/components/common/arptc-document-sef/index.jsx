...
const ARPTCDocumentSEF = ({ data, selectedMonth, selectedYear }) => {
    ...
    <>
      <View style={styles.tableRow}>
        ...
        <View style={styles.basicHeader}>
          <Text style={styles.tableCellHeader}>SEF</Text>
          <View
            style={{
              flexDirection: "row",
              borderTopWidth: 1,
  ...
  const renderPage = (pageData, date, pageIndex, totalPages, isLastPage) => (
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={{ fontWeight: "bold" }}>SEF</Text>
